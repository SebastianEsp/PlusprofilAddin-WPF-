...
REM build time.
IF EXIST "PlusprofilAddinDocumentation.msha" COPY /Y "PlusprofilAddinDocumentation.msha" HelpContentSetup.msha
...
REM Install the new content.
HelpLibraryManagerLauncher.exe /viewerVersion %1  /locale en-us /wait 0 /operation install /sourceUri "%CD%\PlusprofilAddinDocumentation.msha"
